...
file_path = 'D:\TELKOM\MATERI PERKULIAHAN\Telkom\Semester 5\Penambagan Data\\Hemoglobin.xlsx'  # Ganti dengan nama file spreadsheet Anda
df = pd.read_excel(file_path)

# Asumsi kolom yang berisi data yang akan digunakan untuk boxplot
data = df['Hemoglobin'].dropna().values
...
# Membuat boxplot
plt.boxplot(data)
plt.title("Boxplot dari Data Hemoglobin Perempuan")
plt.show()
